...
public class BattleUI : MonoBehaviour
{
    ...
    private Action onSwitchPressed;
    ...
    public void SetEnemySpriteVisible(bool visible)
    {
        if (enemySprite != null)
        {
            enemySprite.enabled = visible && enemySprite.sprite != null;
        }

        if (enemyTypeIcon != null)
        {
            enemyTypeIcon.enabled = visible && enemyTypeIcon.sprite != null;
        }
    }
    public void SetPlayerSpriteVisible(bool visible)
    {
        ...
        {
            playerSprite.enabled = visible && playerSprite.sprite != null;
        }

        if (playerTypeIcon != null)
        {
            playerTypeIcon.enabled = visible && playerTypeIcon.sprite != null;
        }
    }
